...
#import "SQBasicAuthTokenProvider.h"
#import "SQLogger.h"

@interface SQDefaultConfiguration ()
...
@implementation SQDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static SQDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    self = [super init];
    if (self) {
        _host = @"https://connect.squareup.com";
        _username = @"";
        _password = @"";
        _accessToken= @"";
        _verifySSL = YES;
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [SQBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
