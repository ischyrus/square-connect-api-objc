#import "SQResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const SQDeserializationErrorDomainKey = @"SQDeserializationErrorDomainKey";

NSInteger const SQTypeMismatchErrorCode = 143553;

NSInteger const SQEmptyValueOccurredErrorCode = 143509;

NSInteger const SQUnknownResponseObjectErrorCode = 143528;


@interface SQResponseDeserializer ()
...
@implementation SQResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:SQDeserializationErrorDomainKey code:SQTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:SQDeserializationErrorDomainKey code:SQEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:SQDeserializationErrorDomainKey code:SQUnknownResponseObjectErrorCode userInfo:userInfo];
}
