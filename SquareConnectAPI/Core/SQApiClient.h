...
@interface SQApiClient : AFHTTPSessionManager

@property (nonatomic, strong, readonly) id<SQConfiguration> configuration;

@property(nonatomic, assign) NSTimeInterval timeoutInterval;

@property(nonatomic, strong) id<SQResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<SQSanitizer> sanitizer;
