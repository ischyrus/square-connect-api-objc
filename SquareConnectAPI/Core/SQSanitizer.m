#import "SQSanitizer.h"
#import "SQObject.h"
#import "SQQueryParamCollection.h"
#import "SQDefaultConfiguration.h"
#import <ISO8601/ISO8601.h>

NSString * const kSQApplicationJSONType = @"application/json";
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[SQQueryParamCollection class]]) {
        return object;
    }
    else if ([object isKindOfClass:[NSDate class]]) {
        return [SQSanitizer dateToString:object];
    }
    ...
    else if ([object isKindOfClass:[SQObject class]]) {
...
- (NSString *) parameterToString:(id)param {
    if ([param isKindOfClass:[NSString class]]) {
        ...
        return [SQSanitizer dateToString:param];
    }
...
+ (NSString *)dateToString:(id)date {
    NSTimeZone* timeZone = [SQDefaultConfiguration sharedConfig].serializationTimeZone;
