...
@class SQCustomerCreationSourceFilter;
@protocol SQCustomerCustomAttributeFilters;
@class SQCustomerCustomAttributeFilters;
...
@interface SQCustomerFilter : SQObject

/* A filter to select customers based on their creation source. [optional]
 */
@property(nonatomic) SQCustomerCreationSourceFilter* creationSource;
/* A filter to select customers based on when they were created. [optional]
 */
@property(nonatomic) SQTimeRange* createdAt;
/* A filter to select customers based on when they were last updated. [optional]
 */
 ...
 */
@property(nonatomic) SQCustomerTextFilter* emailAddress;
 ...
 */
@property(nonatomic) SQCustomerTextFilter* phoneNumber;
 ...
 */
@property(nonatomic) SQCustomerTextFilter* referenceId;
 ...
 */
@property(nonatomic) SQFilterValue* groupIds;
 ...
 */
@property(nonatomic) SQCustomerCustomAttributeFilters* customAttribute;
 ...
 */
@property(nonatomic) SQFilterValue* segmentIds;
