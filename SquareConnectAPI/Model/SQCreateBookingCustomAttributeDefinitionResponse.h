...
@protocol SQCreateBookingCustomAttributeDefinitionResponse
@end

@interface SQCreateBookingCustomAttributeDefinitionResponse : SQObject

/* The newly created custom attribute definition. [optional]
 */
