...
@protocol SQBatchRetrieveInventoryChangesResponse
@end

@interface SQBatchRetrieveInventoryChangesResponse : SQObject

/* Any errors that occurred during the request. [optional]
 */
@property(nonatomic) NSArray<SQError>* errors;
/* The current calculated inventory changes for the requested objects and locations. [optional]
 */
