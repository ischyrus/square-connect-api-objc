...
@interface SQOrderServiceCharge : SQObject

/* A unique ID that identifies the service charge only within this order. [optional]
 */
@property(nonatomic) NSString* uid;
/* The name of the service charge. [optional]
 */
@property(nonatomic) NSString* name;
/* The catalog object ID referencing the service charge [CatalogObject](https://developer.squareup.com/reference/square_2023-10-18/objects/CatalogObject). [optional]
 */
...
/* The service charge percentage as a string representation of a decimal number. For example, `\"7.25\"` indicates a service charge of 7.25%.  Exactly 1 of `percentage` or `amount_money` should be set. [optional]
 */
@property(nonatomic) NSString* percentage;
/* The amount of a non-percentage-based service charge.  Exactly one of `percentage` or `amount_money` should be set. [optional]
 */
...
/* The calculation phase at which to apply the service charge. [optional]
 */
@property(nonatomic) NSString* calculationPhase;
/* Indicates whether the service charge can be taxed. If set to `true`, order-level taxes automatically apply to the service charge. Note that service charges calculated in the `TOTAL_PHASE` cannot be marked as taxable. [optional]
 */
...
/* The type of the service charge. [optional]
 */
