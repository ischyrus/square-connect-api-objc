...
@class SQOrderFulfillmentDeliveryDetails;
@protocol SQOrderFulfillmentFulfillmentEntry;
@class SQOrderFulfillmentFulfillmentEntry;
@protocol SQOrderFulfillmentPickupDetails;
@class SQOrderFulfillmentPickupDetails;
@protocol SQOrderFulfillmentShipmentDetails;
@class SQOrderFulfillmentShipmentDetails;



@protocol SQOrderFulfillment
@end

@interface SQOrderFulfillment : SQObject
 ...
 */
@property(nonatomic) NSArray<SQOrderFulfillmentFulfillmentEntry>* entries;
 ...
 */
@property(nonatomic) SQOrderFulfillmentPickupDetails* pickupDetails;
 ...
 */
@property(nonatomic) SQOrderFulfillmentShipmentDetails* shipmentDetails;
/* Describes delivery details of an order fulfillment. [optional]
 */
@property(nonatomic) SQOrderFulfillmentDeliveryDetails* deliveryDetails;
