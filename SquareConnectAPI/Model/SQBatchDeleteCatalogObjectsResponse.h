...
@protocol SQBatchDeleteCatalogObjectsResponse
@end

@interface SQBatchDeleteCatalogObjectsResponse : SQObject

/* Any errors that occurred during the request. [optional]
 */
@property(nonatomic) NSArray<SQError>* errors;
/* The IDs of all CatalogObjects deleted by this request. [optional]
 */
