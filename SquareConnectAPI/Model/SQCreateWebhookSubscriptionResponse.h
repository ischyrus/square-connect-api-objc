...
@protocol SQCreateWebhookSubscriptionResponse
@end

@interface SQCreateWebhookSubscriptionResponse : SQObject

/* Information on errors encountered during the request. [optional]
 */
@property(nonatomic) NSArray<SQError>* errors;
/* The new [Subscription](https://developer.squareup.com/reference/square_2023-10-18/objects/WebhookSubscription). [optional]
 */
