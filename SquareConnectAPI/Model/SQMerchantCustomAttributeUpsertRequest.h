...
@interface SQMerchantCustomAttributeUpsertRequest : SQObject

/* The ID of the target [merchant](https://developer.squareup.com/reference/square_2023-10-18/objects/Merchant). 
 */
