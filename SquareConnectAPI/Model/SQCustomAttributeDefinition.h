...
@interface SQCustomAttributeDefinition : SQObject
 ...
 */
@property(nonatomic) NSObject* schema;
/* The name of the custom attribute definition for API and seller-facing UI purposes. The name must be unique within the seller and application pair. This field is required if the `visibility` field is `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`. [optional]
 */
@property(nonatomic) NSString* name;
/* Seller-oriented description of the custom attribute definition, including any constraints that the seller should observe. May be displayed as a tooltip in Square UIs. This field is required if the `visibility` field is `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`. [optional]
 */
@property(nonatomic) NSString* _description;
/* Specifies how the custom attribute definition and its values should be shared with the seller and other applications. If no value is specified, the value defaults to `VISIBILITY_HIDDEN`. [optional]
 */
...
/* The timestamp that indicates when the custom attribute definition was created or most recently updated, in RFC 3339 format. [optional]
 */
@property(nonatomic) NSString* updatedAt;
/* The timestamp that indicates when the custom attribute definition was created, in RFC 3339 format. [optional]
 */
