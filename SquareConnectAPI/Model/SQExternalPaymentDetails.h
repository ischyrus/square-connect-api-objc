...
@interface SQExternalPaymentDetails : SQObject
...
/* An ID to associate the payment to its originating source. [optional]
 */
@property(nonatomic) NSString* sourceId;
/* The fees paid to the source. The `amount_money` minus this field is  the net amount seller receives. [optional]
 */
@property(nonatomic) SQMoney* sourceFeeMoney;
