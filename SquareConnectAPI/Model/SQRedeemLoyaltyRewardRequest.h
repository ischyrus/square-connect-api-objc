...
@protocol SQRedeemLoyaltyRewardRequest
@end

@interface SQRedeemLoyaltyRewardRequest : SQObject
...
/* The ID of the [location](https://developer.squareup.com/reference/square_2023-10-18/objects/Location) where the reward is redeemed. 
 */
