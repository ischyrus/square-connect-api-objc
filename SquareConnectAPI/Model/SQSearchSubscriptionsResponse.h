...
@protocol SQSearchSubscriptionsResponse
@end

@interface SQSearchSubscriptionsResponse : SQObject

/* Errors encountered during the request. [optional]
 */
@property(nonatomic) NSArray<SQError>* errors;
/* The subscriptions matching the specified query expressions. [optional]
 */
@property(nonatomic) NSArray<SQSubscription>* subscriptions;
