...
@protocol SQUpdateOrderCustomAttributeDefinitionResponse
@end

@interface SQUpdateOrderCustomAttributeDefinitionResponse : SQObject

/* The updated order custom attribute definition. [optional]
 */
