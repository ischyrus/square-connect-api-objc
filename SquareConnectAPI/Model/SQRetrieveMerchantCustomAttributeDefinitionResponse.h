...
@protocol SQRetrieveMerchantCustomAttributeDefinitionResponse
@end

@interface SQRetrieveMerchantCustomAttributeDefinitionResponse : SQObject

/* The retrieved custom attribute definition. [optional]
 */
