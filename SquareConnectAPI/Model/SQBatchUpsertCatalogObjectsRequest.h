...
@class SQCatalogObjectBatch;



@protocol SQBatchUpsertCatalogObjectsRequest
@end

@interface SQBatchUpsertCatalogObjectsRequest : SQObject
 ...
 */
@property(nonatomic) NSArray<SQCatalogObjectBatch>* batches;
