...
@class SQOrderFulfillmentPickupDetailsCurbsidePickupDetails;
...
@interface SQOrderFulfillmentPickupDetails : SQObject
 ...
 */
@property(nonatomic) SQOrderFulfillmentPickupDetailsCurbsidePickupDetails* curbsidePickupDetails;
