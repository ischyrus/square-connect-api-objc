...
@protocol SQRetrieveInventoryCountResponse
@end

@interface SQRetrieveInventoryCountResponse : SQObject

/* Any errors that occurred during the request. [optional]
 */
@property(nonatomic) NSArray<SQError>* errors;
/* The current calculated inventory counts for the requested object and locations. [optional]
 */
