...
@protocol SQCancelSubscriptionResponse
@end

@interface SQCancelSubscriptionResponse : SQObject

/* Errors encountered during the request. [optional]
 */
@property(nonatomic) NSArray<SQError>* errors;
/* The specified subscription scheduled for cancellation according to the action created by the request. [optional]
 */
@property(nonatomic) SQSubscription* subscription;
/* A list of a single `CANCEL` action scheduled for the subscription. [optional]
 */
