...
@interface SQSitesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SQSitesApi

NSString* kSQSitesApiErrorDomain = @"SQSitesApiErrorDomain";
NSInteger kSQSitesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) listSitesWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SQListSitesResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SQListSitesResponse*)data, error);
                                }
                            }];
}
