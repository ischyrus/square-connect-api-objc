# SQOrderFulfillmentPickupDetails

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**recipient** | [**SQOrderFulfillmentRecipient***](SQOrderFulfillmentRecipient.md) | Information about the person to pick up this fulfillment from a physical location. | [optional] 
...
**curbsidePickupDetails** | [**SQOrderFulfillmentPickupDetailsCurbsidePickupDetails***](SQOrderFulfillmentPickupDetailsCurbsidePickupDetails.md) | Specific details for curbside pickup. These details can only be populated if &#x60;is_curbside_pickup&#x60; is set to &#x60;true&#x60;. | [optional] 
